...
**Source:** gtm-architect-factors-api-reference.md
...
1. Clone this repository:
   ```bash
   git clone https://github.com/diamitani/gtm_architect_factors_api_reference-skill.git
   ```
...
2. Import the skill into your agent framework:
   ...
   # For Hermes Agent
   skill_view(name='gtm_architect_factors_api_reference')
   ```
